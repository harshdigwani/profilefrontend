                ...
                <div className="container justify-center align-center ">
                    <div className="width-60">
                        <div className="container align-center">
                            ...
                            <b className="badge right" onClick={this.editProject}><span className="fa fa-pencil" /> Edit</b>
                        </div>
                        <div className="container align-center">
                        ...
                        <p className="content">
                            {project.description}I always used to wonder how these amazing websites are being created? What am I missing out or what goes wrong which makes my website less attractive? So to answer these queries, this article will surely help you out to design your next amazing web site.
1. Layout -
